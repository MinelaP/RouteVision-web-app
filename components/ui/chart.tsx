...
// REŠENJE ZA SVE TS GREŠKE: Eksplicitno definisani Tooltip props
interface ChartTooltipContentProps
    ...
    nameKey?: string
    labelKey?: string
    // Eksplicitno dodajemo svojstva koja TS "gubi"
    payload?: any[]
    label?: any
    active?: boolean
}
                                ...
                                {formatter && item?.value !== undefined && item.name ? (
                                    ...
                                    <>
                                        {itemConfig?.icon ? (
                                            ...
                                            !hideIndicator && (
                                                <div
                                                    className={cn('shrink-0 rounded-[2px] border-border', {
